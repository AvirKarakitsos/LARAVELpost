<x-app-layout>
    ...
    <form action="{{route('admin.posts.update',$post)}}" method="post" enctype="multipart/form-data" class="w-96 mx-auto my-5 p-3 border">
        @csrf
        @method('put')
        ...
        <span id="cpt"></span>
        <textarea  name="content" id="content" class="w-full h-32">{{$post->content}}</textarea>
        ...
        <div class="flex justify-around">
            ...
            <button class="w-1/2 p-1 font-bold hover:bg-gray-300"><a href="{{route('admin.posts.index')}}">Retour</a></button>
        </div>
    </form>
